...
class CtaMomentumStrategy(Strategy):
    ...
    def __init__(self, asset_type, symbols_list, freq, s_period_lst, l_period_lst, SW, PW, targetVol,maxLeverage,
        ...
        self._strategy_name = 'CtaMomentumStrategy'
    ...
    def gen_signal(self, symbol, **kwargs):
        ...
        _signal = 0
        net = 1
        capital_intial = 10 * capital / len(self._symbol_pair_list) / self._contract_size_dict[symbol]
    ...
    def _format_data(self, symbol):
        ...
        scaledSig = 1 / 5 * (data_daily['uk0'] + data_daily['uk1'] + data_daily['uk2'] + data_daily['uk3'] + data_daily['uk4'])
        ...
        data_daily.to_csv(self.result_fold + '/data.csv')
